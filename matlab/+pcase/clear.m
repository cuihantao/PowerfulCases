function clear(name)
%CLEAR Remove a cached case
%   pcase.clear(name) removes the specified case from the cache.
%   pcase.clear() with no arguments removes all cached cases.
%
%   Arguments:
%       name - (Optional) Case name to remove. If not specified, removes all.
%
%   Example:
%       pcase.clear('ACTIVSg70k');  % Remove specific case
%       pcase.clear();               % Remove all cached cases
%
